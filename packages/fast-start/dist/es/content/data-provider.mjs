import { provide as Ie, inject as qe } from "vue";
function ye(e, t) {
  return function() {
    return e.apply(t, arguments);
  };
}
const { toString: Me } = Object.prototype, { getPrototypeOf: Z } = Object, H = /* @__PURE__ */ ((e) => (t) => {
  const n = Me.call(t);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), A = (e) => (e = e.toLowerCase(), (t) => H(t) === e), I = (e) => (t) => typeof t === e, { isArray: C } = Array, F = I("undefined");
function ze(e) {
...
const Ve = I("string"), R = I("function"), we = I("number"), q = (e) => e !== null && typeof e == "object", $e = (e) => e === !0 || e === !1, L = (e) => {
  if (H(e) !== "object")
    return !1;
  const t = Z(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, We = A("Date"), ve = A("File"), Ke = A("Blob"), Xe = A("FileList"), Ge = (e) => q(e) && R(e.pipe), Qe = (e) => {
  let t;
...
function v() {
  const { caseless: e } = Re(this) && this || {}, t = {}, n = (r, s) => {
    const o = e && be(t, s) || s;
    L(t[o]) && L(r) ? t[o] = v(t[o], r) : L(r) ? t[o] = v({}, r) : C(r) ? t[o] = r.slice() : t[o] = r;
  };
...
const et = (e, t, n, { allOwnKeys: r } = {}) => (D(t, (s, o) => {
  ...
  for (; t-- > 0; )
    n[t] = e[t];
  return n;
}, it = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && Z(Uint8Array)), at = (e, t) => {
...
), oe = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), ft = A("RegExp"), Oe = (e, t) => {
...
}, mt = (e, t) => (e = +e, Number.isFinite(e) ? e : t), J = "abcdefghijklmnopqrstuvwxyz", ie = "0123456789", Ae = {
  DIGIT: ie,
  ALPHA: J,
...
const wt = (e) => {
  ...
  return n(e, 0);
}, bt = A("AsyncFunction"), St = (e) => e && (q(e) || R(e)) && R(e.then) && R(e.catch), a = {
  isArray: C,
  isArrayBuffer: Ee,
  isBuffer: ze,
  isFormData: Qe,
...
function M(e, t, n) {
  ...
  function l(f, d, w) {
    ...
    if (f && !w && typeof f == "object") {
      ...
      else if (a.isArray(f) && Ot(f) || (a.isFileList(f) || a.endsWith(d, "[]")) && (b = a.toArray(f)))
        return d = ge(d), b.forEach(function(g, He) {
    ...
    return K(f) ? !0 : (t.append(ae(w, d, o), h(f)), !1);
  }
  const u = [], E = Object.assign(At, {
    defaultVisitor: l,
    convertValue: h,
    isVisitable: K
  });
...
}, Pt = typeof URLSearchParams < "u" ? URLSearchParams : Y, gt = typeof FormData < "u" ? FormData : null, xt = typeof Blob < "u" ? Blob : null, Nt = {
  isBrowser: !0,
  classes: {
    URLSearchParams: Pt,
    FormData: gt,
...
}, _e = typeof window < "u" && typeof document < "u", Ct = ((e) => _e && ["ReactNative", "NativeScript", "NS"].indexOf(e) < 0)(typeof navigator < "u" && navigator.product), _t = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
...
function Fe(e) {
  function t(n, r, s, o) {
    ...
    return i = !i && a.isArray(s) ? s.length : i, p ? (a.hasOwnProp(s, i) ? s[i] = [s[i], r] : s[i] = r, !c) : ((!s[i] || !a.isObject(s[i])) && (s[i] = []), t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = Lt(s[i])), !c);
  }
...
const Xt = typeof XMLHttpRequest < "u", Gt = Xt && function(e) {
  return new Promise(function(n, r) {
    ...
    }, O.hasStandardBrowserEnv && (c && a.isFunction(c) && (c = c(e)), c || c !== !1 && Wt(E))) {
...
const de = (e) => `- ${e}`, Qt = (e) => a.isFunction(e) || e === null || e === !1, Le = {
  getAdapter: (e) => {
    ...
    for (let o = 0; o < t; o++) {
      n = e[o];
      let i;
      if (r = n, !Qt(n) && (r = X[(i = String(n)).toLowerCase()], r === void 0))
...
function pe(e) {
  return W(e), e.headers = T.from(e.headers), e.data = $.call(
    e,
    e.transformRequest
    ...
    return De(r) || (W(e), r && r.response && (r.response.data = $.call(
      e,
      e.transformResponse,
      r.response
...
class se extends Error {
  constructor(t, n, r = null) {
    super(t), this.message = t, this.status = n, this.body = r, Object.setPrototypeOf(this, se.prototype), this.name = this.constructor.name, typeof Error.captureStackTrace == "function" ? Error.captureStackTrace(this, this.constructor) : this.stack = new Error(t).stack, this.stack = new Error().stack;
  }
}
async function sn(e, t = {}) {
  const r = await rn.create({
    baseURL: t.baseUrl || ""
  })({ ...t, url: e }), { status: s, statusText: o, headers: i, body: c } = {
    status: r.status,
  ...
  let p = c;
  return s < 200 || s >= 300 ? Promise.reject(new se(o, s)) : await Promise.resolve({ status: s, headers: i, body: c, json: p });
}
const on = {
  ...
  // avoids adding a context in tests
  httpClient: sn
}, je = Symbol("DATA_PROVIDER_CONTEXT"), cn = (e) => Ie(je, e), un = () => qe(je, on);
export {
  je as DATA_PROVIDER_CONTEXT,
  cn as createDataProviderProvider,
  un as useDataProviderContext
};
//# sourceMappingURL=data-provider.mjs.map
